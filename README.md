...
If your solar is AC-coupled (micro-inverters) and you want Zero Export and use such a rectifier as a battery charger, you can [control it using your export meter MQTT output via NodeRed.](https://github.com/mjpalmowski/CAN-BUS-control-R4875G1-with-ESPHome-and-MQTT/discussions/8)
