...
If you are looking to [go BIG](https://www.youtube.com/watch?v=OHAXydKthXM) and [add another R4875G1 to your CAN BUS](./discussions/4) to your CAN BUS here is an example that allows you to set values for all units simultaneously and receive the sensor data separately:
