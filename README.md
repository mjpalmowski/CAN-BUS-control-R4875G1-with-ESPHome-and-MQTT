...
## Use Cases
This setup is ideal for charging common 15s and 16s LiFePO4 packs and 14s NMC batteries, making it useful for home battery systems that store solar or off-peak power. It is particularly useful when backing up solar setups with a generator. Additionally, it can serve as a powerful DC bench power supply when paired with a robust [adjustable](./mjpalmowski/esphome-juntek-DPM8650-mqtt-http-tool) buck/boost converter, or even as an onboard e-bike charger.
