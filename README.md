...
|---------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------|
| Charger delivers full current as battery approaches FULL → risk of repeated high current disconnect at 55–58 V | Current tapers, e.g. 25 A → 15 A → 10 A → 5 A, allowing the pack to reach 100 % SOC without discconnect |
